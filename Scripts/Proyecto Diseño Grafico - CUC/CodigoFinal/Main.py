...
import json
import os
from ObtenerCoordenadasCotas import *
from ObtenerCoordenadasMuros import *
from ImprimirLogitud import *
...
def abrir_archivo_dxf():
    try:
        ...
        Ruta_arc_Publica.append(ruta_archivo)
...
def init():
    ...
    cargarJson()
    IterarEntidad(Ruta_arc_Publica)
    ObtenerCotas(Ruta_arc_Publica)   
    BuscarArchivos()
